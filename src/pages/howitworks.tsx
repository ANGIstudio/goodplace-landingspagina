  ...
  return (
    <Base>
      ...
      <Section bgImage="bg-howitworks2">
        <Wrapper>
          <div className="flex md:flex-row flex-col ml-8 lg:space-x-6 md:space-x-6 md:items-center overflow-hidden md:-mb-0 -mb-32">
      ...
      <Section noPaddingBottom noPaddingTop bgImage="bg-howitworks3">
        <Wrapper>
          <div className="flex md:flex-row flex-col-reverse ml-8 py-16 md:py-4 lg:space-x-32 md:space-x-16 md:space-y-16 overflow-hidden md:-mt-16">
            <div className="-mb-48 sm:-mb-64 md:mb-28 max-w-md relative">
