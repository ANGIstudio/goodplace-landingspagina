      ...
      <Section bgColor="lightgreen">
        ...
        <div className="text-darkgreen">
          <div className="m-auto items-center max-w-lg">
            ...
            <p className="text-darkgreen font-medium md:text-4xl text-2xl text-justify">
              een betere <strong><em>wereld voor mens, dier en natuur.</em></strong>
            </p>
          </div>
        </div>
        ...
        <div className="md:w-2/5 md:-mt-16 -mt-4">
          <p className="text-darkgreen pb-4 font-medium md:text-xl text-lg text-justify">
            ...
            geconfronteerd voelt met een wereld die wellicht in hun leven
            al grotendeels onleefbaar wordt. De urgentie om een steentje bij
            te dragen en impact te maken voelden zij zeker, maar toch
            voelden zij zich tegengehouden te doneren aan goede doelen.
            <br />
            <br />
            ...
            boeken van hun sportklasjes: “Er zijn zóveel problemen in de wereld,
            en zoveel organisaties, klein en groot, die allemaal goede dingen
            doen. We zagen door de bomen het bos niet meer.”
          </p>
        </div>
       </div>
         <div className="flex md:flex-row flex-col-reverse justify-center md:space-x-12 overflow-hidden">
           <div className="md:w-2/5">
             ...
             <p className="text-darkgreen font-medium md:text-xl text-lg ml-10 text-justify">
               ...
               waardoor significant minder geld op de juiste plek terechtkomt.
               Ze zochten een digitaal alternatief waarbij de donateur doneren
               weer als iets positiefs kon zien: <strong>“Een donatie zou ook een
               dopamine-shot kunnen losmaken”</strong>
              </p>
            </div>
            <div>
        ...
        <div className="m-auto items-center max-w-lg">
          <h2 className="mb-2 text-darkgreen font-black break-words lg:text-5xl md:text-3xl">
             ...
             Al vanaf het begin zijn Yoni, Leopold en Yvo bij Goodplace betrokken. Zij zijn onze belangrijkste ambassadeurs en staan altijd klaar om zich in te zetten voor Goodplace.
...
<div className="md:mb-24">
        <div className="text-lightgreen">
              ...
              <h2 className="text-lightgreen md:mb-20 mb-8 font-black break-words lg:text-5xl md:text-3xl text-center">Onze <br />missie</h2>
      </div>

<div className="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-12 md:mt-4 md:mx-32 md:mb-12">
<div>
<p className="text-lightgreen font-extrabold md:text-3xl text-2xl text-center"><em>”We creëren meer impact voor de wereld door doneren flexibel, overzichtelijk en leuk te maken.”</em></p>
<br />
<p className="text-center md:text-xl text-lg text-justify text-lightgreen font-bold">Wij geloven dat iedereen impact kan maken en positieve verandering teweeg kan brengen, en dat dat zo simpel mogelijk moet zijn. <br /><br />
</p>
<p className="text-center md:text-xl md:text-lg text-justify text-lightgreen font-medium text-base">Ons doel is om mensen te inspireren en aan te moedigen om bewuste gevers te worden.  Door een platform te creëren dat de brug slaat tussen  </p>
</div>
<div><p className="text-center md:text-xl md:text-lg text-base text-justify text-lightgreen font-medium"> iedereen die goed wil doen en de goede doelen, willen we een positieve impact creëren op belangrijke maatschappelijke thema’s, van oorlog, klimaat en onderwijs tot de LGBTQIA+ beweging en eenzame ouderen. Transparantie, flexibiliteit, overzicht en gemak zijn hierbij onze belangrijkste kernwaarden.
<br /><br />
Goodplace is er enerzijds om bestaande drempels bij doneren weg te nemen. Anderzijds willen we dat jij kunt geven aan dingen die jou persoonlijk raken.</p></div>
